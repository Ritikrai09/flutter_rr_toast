...
import 'package:flutter_rr_toast/src/rr_toast_widget.dart';
...
class RRToastManager extends StatefulWidget {
  final Widget child;

  const RRToastManager({Key? key, required this.child}) : super(key: key);

  @override
  RRToastManagerState createState() => RRToastManagerState();
}
...
class RRToastManagerState extends State<RRToastManager> {
